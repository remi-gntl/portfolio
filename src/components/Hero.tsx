      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a
              href="#projects"
              className="group bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg shadow-blue-500/20 flex items-center gap-2"
            >
              Voir mes projets
            ...
            <a
              href="/cv.pdf"
              target="_blank"
              download="CV_Remi_Gentil.pdf"
              className="group px-8 py-3 rounded-xl font-bold transition-all bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 text-white flex items-center gap-2"
            >
          ...
          <div className="flex items-center gap-4 pt-4">
            <a
              href="https://github.com/remi-gntl"
              target="_blank"
              className="p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-blue-500/30 hover:text-blue-400 transition-all"
            >
              <Github size={22} />
            </a>
            <a
              href="https://www.linkedin.com/in/remi-gentil/"
              target="_blank"
              className="p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:border-blue-500/30 hover:text-blue-400 transition-all"
            >
              <Linkedin size={22} />
